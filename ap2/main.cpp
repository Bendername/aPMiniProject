...
//cout << "Printing value for point from the graph: "  << pol2.ValuateAtPoint(1.5);

// A method to compute a polynomial which is a derivative of the polynomial.

Polynomial<double> poli = pol2.CalculateDerivative();
cout << "Printing the polynomial with the additional roots added: " << poli.GetFormula() << "\n";
